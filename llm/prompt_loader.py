...
_LAB_DIR = _PROJECT_ROOT / "prompt_lab"


def load_lab_prompt(name: str) -> str:
    """Read a prompt template from prompt_lab/{name}.txt on every call.
    ...
    Raises:
        FileNotFoundError: If the prompt file does not exist under prompt_lab/.
    """
